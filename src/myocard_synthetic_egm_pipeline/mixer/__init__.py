...
column, emits a hybrid ClassifierBank. Per-trace mixer audit fields
...
- :func:`mix_classifier_bank` — orchestrator; takes a clean
  ClassifierBank + a Pydantic NoiseBank, returns a hybrid
  ClassifierBank.
- :func:`snr_scale`, :func:`sample_noise_for_length` — pure-math
  helpers exposed for tests + offline analysis.
- :func:`write_hybrid_synthetic_bank_from_classifier` — optional
